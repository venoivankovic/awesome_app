...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ] ; then
	CC_SRC_PATH="../awesome/awesome_chaincode/go/"
elif [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
	CC_SRC_PATH="../awesome/awesome_chaincode/javascript/"
elif [ "$CC_SRC_LANGUAGE" = "java" ]; then
	CC_SRC_PATH="../awesome/awesome_chaincode/java"
elif [ "$CC_SRC_LANGUAGE" = "solidity" ]; then
	CC_SRC_PATH="../awesome/awesome_chaincode/solidity/"
else
...
./network.sh deployCC -ccn awesome -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH} -ccep "OR('Org1MSP.peer','Org2MSP.peer')"
popd
